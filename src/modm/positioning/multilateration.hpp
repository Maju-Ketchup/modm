...
*/
	...
	*/
	static void activemultilaterationNewton (Vector<floatunit, 3> &output,
...
private:
	...
	static void newton(modm::Matrix<floatunit,4,4> anchormatrix,modm::Matrix<floatunit,4,1> &result);
};
