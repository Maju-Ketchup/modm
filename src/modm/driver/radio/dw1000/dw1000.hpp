 ...
 * I added some 'userfriendly functions'
 * and set all others to privat *mja*
 *
 * DONE --> translating to C++, easy-to-use functions without register calls, move static constexpr in class part -> create enums, IRQ
 * WIP  --> modm integration
 * TODO --> Cleanup
*/
#ifndef _DW1000_HPP
#define _DW1000_HPP
#ifndef MODM__LOGGER_HPP
...
*
	...
	*/
	...
	/**
	*@brief
	* This function fills the buffer with [size] bytes of the received frame without sanity-check!!
	*@param buffer
	*@param length
